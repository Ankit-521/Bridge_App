...
Image {
    ...
    signal newGame()
    signal closed()
    property variant win; // PopUp window when alert is received "ankit"
...
// ankit
    ...
    Connections {
        ...
        onBoardReceived: setBoard(dealer, vulnerable,table, round, boardNo, ns_pair, ew_pair);
     ...
     /* By chanchal Dass 05012021
        ...
        // ankit
        onAlertnotificationReceived:showNotification(alert);// alert is received in qml "ankit"
        onClaimReceived:{
        ...
        onClaimresponseReceived:{
            ...
            if(((me.num==(playerTo+1)%4 || me.num==(playerTo+3)%4)) && claimDialog.visible==true){
            ...
            if(response=="accepted"){
                Logic.endbyclaim(num_tricks,(playerTo==me.num || (playerTo+2)%4==me.num));
            }
        }
    ...
    Dialog{
        ...
        onYes: {
            ...
            talker.broadcastClaimResponse(1,claimDialog.fromplayer,"accepted",claimDialog.num);
        ...
        onNo: {
            //challenging
            //continue the game
            talker.broadcastClaimResponse(1,claimDialog.fromplayer,"rejected",claimDialog.num);
        }
    }
    Dialog{
    ...
    function addMessageChat(type, message, sender){ Logic.addMessageChat(type, message, sender) }
    ...
    Display {
        ...
        contract:(phase>1)?( (Logic.lastValidBid!=="")? Logic.lastValidBid.split(":")[1]:""): ""
...
*/
    ...
    Button {
        id: claim
        visible: (((turn===me.num|| topPlayer.mouseEnabled) && phase===2)&&Logic.lastCard===-1) //
